...
func resourceMSOSchemaSiteVrfRegionImport(d *schema.ResourceData, m interface{}) ([]*schema.ResourceData, error) {
	...
	if !found {
		return nil, fmt.Errorf("Unable to find the Site Vrf Region %s", stateRegion)
	}
